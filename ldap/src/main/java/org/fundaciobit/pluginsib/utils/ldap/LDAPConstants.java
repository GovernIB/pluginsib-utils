...
public interface LDAPConstants {
    ...
    String LDAP_DEPARTMENT_ATTRIBUTE = "ldap.attribute.department";

    String LDAP_ADDITIONAL_ATTRIBUTES = "ldap.additional.attributes";

    /**
     * All LDAP properties.
     */
    String[] LDAP_PROPERTIES = new String[] { LDAP_PROVIDERURL, LDAP_SECURITYAUTHENTICATION, LDAP_SECURITYPRINCIPAL,
            LDAP_SECURITYCREDENTIALS, LDAP_USERSCONTEXTDN, LDAP_SEARCHSCOPE, LDAP_SEARCHFILTER,
            PREFIX_ROLE_MATCH_MEMBEROF, SUFFIX_ROLE_MATCH_MEMBEROF,
            // ATTRIBUTES
            LDAP_USERNAME_ATTRIBUTE, LDAP_EMAIL_ATTRIBUTE, LDAP_ADMINISTRATIONID_ATTRIBUTE, LDAP_NAME_ATTRIBUTE,
            LDAP_SURNAMES_ATTRIBUTE, LDAP_SURNAME1_ATTRIBUTE, LDAP_SURNAME2_ATTRIBUTE, LDAP_TELEPHONE_ATTRIBUTE,
            LDAP_DEPARTMENT_ATTRIBUTE, LDAP_MEMBEROF_ATTRIBUTE, LDAP_ADDITIONAL_ATTRIBUTES };
