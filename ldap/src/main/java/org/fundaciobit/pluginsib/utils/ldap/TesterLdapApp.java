...
public class TesterLdapApp extends JFrame implements LDAPConstants {
    ...
    static {
        ...
        defvalues.put("ldap.search_filter",
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (returnVal == JFileChooser.APPROVE_OPTION) {
                    ...
                    try {
                        ...
                        e1.printStackTrace();
                        JOptionPane.showMessageDialog(null, "Error obrint fitxer de propietats: " + e1.getMessage());
                    }
                }
            }
        }));
    ...
    protected String userExists(String username) {
        try {
            ...
            StringBuffer str = new StringBuffer(
                    "USERNAME EXISTS " + username + "? " + this.ldapUserManager.userExists(username));
