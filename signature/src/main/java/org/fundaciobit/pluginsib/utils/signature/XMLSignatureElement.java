...
// https://github.com/ctt-gob-es/integra/blob/master/Integra-parent/Integra-commons-xml/src/main/java/net/java/xades/security/xml/XMLSignatureElement.java
...
public class XMLSignatureElement {
	...
	AccessController.doPrivileged(new java.security.PrivilegedAction<Void>() {
		...
		// TODO XYZ ZZZ Security.insertProviderAt(new org.apache.jcp.xml.dsig.internal.dom.XMLDSigRI(), 1);
		// }
		// catch (Throwable e)
		// {
		// e.printStackTrace();
	...
	if (xmlSignatureFactory == null) {
	    xmlSignatureFactory = XMLSignatureFactory.getInstance("DOM"); // TODO XYZ ZZZ , new IntegraProvider());
	}
